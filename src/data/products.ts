...
export const PRODUCTS: Product[] = [
  {
    ...
    color: "#FF2200",
    description: "Racing Red Taillight Edition · Limited Collection Exclusive",
    category: "cars",
    sizes: ["A2 — Standard Size (42×59cm)"],
    ledColors: ["#FF2200", "#FF6B00"],
    badge: "Limited Exclusive",
  ...
  },
  {
    ...
    color: "#FF6B00",
    description: "Arancio Borealis Edition · Limited Collection Exclusive",
    category: "cars",
    sizes: ["A2 — Standard Size (42×59cm)"],
...
export const SIZES = ["A2 — Standard Size (42×59cm)"];
export const SIZE_PRICES: Record<string, number> = {
  "A2 — Standard Size (42×59cm)": 2500,
};
